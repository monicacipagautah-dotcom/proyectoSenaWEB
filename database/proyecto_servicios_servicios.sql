...
CREATE TABLE `servicios` (
  ...
  CONSTRAINT `servicios_ibfk_2` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedores` (`id_proveedor`)
...
INSERT INTO `servicios` VALUES (1,1,1,'m','2026-06-24','21:55:00','cra 87d # 48-03 sur','Pendiente'),(2,10,1,'m','2026-06-24','21:59:00','cra 87d # 48-03 sur','Pendiente');
